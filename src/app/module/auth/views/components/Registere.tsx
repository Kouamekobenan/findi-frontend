...
import { RegisterUseCase } from "../../application/usecases/create-user.usecase";
          ...
          <div className="text-center mb-4">
            ...
            <div className="inline-block mb-3">
              <div className="flex justify-center items-center pb-6">
                <Link
                  href="/page"
                  className="inline-flex items-center gap-2 px-6 py-2.5 bg-gray-50 hover:to-cyan-700 text-black font-semibold rounded-2xl shadow-lg hover:shadow-xl transition-all duration-300 transform hover:scale-105"
                >
                  <span>Accueil</span>
                </Link>
              </div>
